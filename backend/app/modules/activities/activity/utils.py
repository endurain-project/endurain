"""Activity search, file relocation and aggregation/computation utilities.

File parsing and ingestion orchestration now live in
:mod:`modules.activities.activity_ingestion`; this module keeps only the
parser-agnostic helpers used by the activities core and by the file parsers
(search escaping, safe file relocation, and the geo/pace/elevation/summary math).
"""
