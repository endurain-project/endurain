...
callers do not import ``modules.auth._internal.internal_dependencies`` directly.
...
whose implementations are identical in ``modules.auth._internal.internal_dependencies`` are
...
from modules.auth._internal.internal_dependencies import (
    AuthContext,
