...
import modules.strava.athlete_utils as strava_athlete_utils
...
def transform_csv_bike_gear_to_schema_gear(bikes_dict: dict, token_user_id: int) -> list[gears_schema.GearCreate]:
    """
