...
class TestListActivityStreams:
    ...
    @patch("modules.activities.activity_streams.service.activity_streams_utils")
    @patch("modules.activities.activity_streams.service.activity_streams_crud")
    @patch("modules.activities.activity_streams.service.activity_child_access")
    def test_non_owner_gets_the_masked_set(self, mock_gate, mock_crud, mock_utils):
        from modules.activities.activity_streams import service
        ...
        mock_utils.filter_visible_streams.return_value = []

        assert service.list_activity_streams(5, 1, MagicMock()) == []
        mock_utils.filter_visible_streams.assert_called_once_with(
...
class TestGetActivityStream:
    ...
    @patch("modules.activities.activity_streams.service.activity_streams_crud")
    @patch("modules.activities.activity_streams.service.activity_child_access")
    def test_hidden_stream_is_none_for_a_non_owner(self, mock_gate, mock_crud, mock_utils):
        from modules.activities.activity_streams import service
        ...
        mock_utils.is_stream_hidden.return_value = True
    ...
    @patch("modules.activities.activity_streams.service.activity_streams_crud")
    @patch("modules.activities.activity_streams.service.activity_child_access")
    def test_owner_sees_a_hidden_stream(self, mock_gate, mock_crud, mock_utils):
        from modules.activities.activity_streams import service
...
class TestPublicStreams:
    ...
    @patch("modules.activities.activity_streams.service.activity_streams_crud")
    @patch("modules.activities.activity_streams.service.activity_child_access")
    def test_public_list_is_always_masked(self, mock_gate, mock_crud, mock_utils):
        ...
        mock_utils.filter_visible_streams.assert_called_once()
    ...
    @patch("modules.activities.activity_streams.service.activity_streams_crud")
    @patch("modules.activities.activity_streams.service.activity_child_access")
    def test_public_hidden_stream_is_none(self, mock_gate, mock_crud, mock_utils):
        from modules.activities.activity_streams import service
