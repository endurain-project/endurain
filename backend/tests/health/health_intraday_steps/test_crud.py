...
class TestGetHealthIntradayStepsNumber:
    """
    Test suite for get_health_intraday_steps_number function.
    """

    def test_get_health_intraday_steps_number_success(self, mock_db):
        """
        Test successful count of health intraday steps records for a user.
        """
        # Arrange
        user_id = 1
        expected_count = 5
        ...
        # Act
        result = health_intraday_steps_crud.get_health_intraday_steps_number(user_id, mock_db)

        # Assert
        assert result == expected_count
        mock_db.execute.assert_called_once()

    def test_get_health_intraday_steps_number_zero(self, mock_db):
        """
        Test count when user has no health intraday steps records.
        """
        # Arrange
        user_id = 1
    ...
    def test_get_health_intraday_steps_number_none(self, mock_db):
        """
        Test count when result is None returns 0.
        """
        # Arrange
        user_id = 1
    ...
    def test_get_health_intraday_steps_number_exception(self, mock_db):
        """
        Test exception handling in get_health_intraday_steps_number.
        """
        # Arrange
        user_id = 1
        ...
        with pytest.raises(HTTPException) as exc_info:
            health_intraday_steps_crud.get_health_intraday_steps_number(user_id, mock_db)
